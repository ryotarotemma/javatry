...
public class Step07ExceptionTest extends PlainTestCase {
    ...
    public void test_exception_cause_basic() {
        ...
        try {
            ...
            Throwable cause = e.getCause(); // IllegalStateExceptionを起こしたExceptionが入る
    ...
    public void test_exception_translation_debugChallenge() {
        try {
            ...
            // - - - - - - - - - -
            //client requestは"steering wheel is like sea"で、このrequestの場合はcatalogKeyは"piari"が選択される
            //この場合steeringWheelIdは3が選択され、specTextは\(^_^)/である
            //specTextが\(^_^)/であるS場合はpecialScrewCannotMakeBySpecExceptionがthrowされる
            // _/_/_/_/_/_/_/_/_/_/
        }
    }
